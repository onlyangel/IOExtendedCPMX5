...
["", "extended.dart", , A, {
  "^": "",
  main: [function() {
    var t1 = J.get$onClick$x(document.querySelector("#databutton"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.metedata$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
    t1 = J.get$onClick$x(document.querySelector("#dataget"));
    H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(A.jaladata$closure()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
  }, "call$0", "main$closure", 0, 0, 1],
  metedata: [function(e) {
    var data, t1;
    P.print("emmmm");
    data = document.querySelector("#dataorigin");
    t1 = J.getInterceptor$x(data);
    window.alert("a meter '" + H.S(t1.get$value(data)) + "'");
    W.HttpRequest_getString("/setdata?data=" + H.S(t1.get$value(data)), null, null);
  }, "call$1", "metedata$closure", 2, 0, 2],
  jaladata: [function(e) {
    W.HttpRequest_getString("/getdata", null, null).then$1(A.jaladata_response$closure());
  }, "call$1", "jaladata$closure", 2, 0, 2],
  jaladata_response: [function(response) {
    document.querySelector("#datadestiny").textContent = response;
  }, "call$1", "jaladata_response$closure", 2, 0, 2]
},
1],
]);
